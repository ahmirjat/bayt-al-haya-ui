  ...
  return (
    <footer className="mt-20 bg-[#584b45] text-[#fffaf6]">
      <div className="container-page grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-4">
        <div><p className="font-serif text-3xl font-semibold">Bayt al-Haya</p><p className="mt-3 max-w-xs text-sm leading-6 text-[#ded1c8]">Faith-inspired abayas, hijabs, prayer wear, and modest essentials for everyday grace.</p><p className="mt-5 text-xs tracking-[.1em] text-[#dec2b5]">Canada · Pakistan · North America</p></div>
      ...
      <div className="border-t border-white/10"><div className="container-page flex flex-wrap justify-between gap-3 py-5 text-xs text-[#bcaea5]"><p>© 2026 Bayt al-Haya. Demo storefront.</p><p>Faith-inspired modest wear for everyday grace.</p></div></div>
    </footer>
  );
}
