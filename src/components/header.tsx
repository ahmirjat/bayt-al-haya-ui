...
export function Header() {
  return (
    <>
      <div className="bg-[#6d5b53] px-4 py-2.5 text-center text-[11px] tracking-[0.12em] text-[#fffaf6]">Complimentary local delivery on orders over $125</div>
      <header className="sticky top-0 z-30 border-b border-[#e5ddd2]/80 bg-[#fffdf9]/95 backdrop-blur">
        <div className="container-page flex flex-col items-center gap-4 py-4 lg:flex-row lg:justify-between">
          <Link href="/" className="group text-center font-serif text-3xl font-semibold tracking-wide text-[#493d37]" data-testid="brand-link">Bayt al-Haya<span className="block font-sans text-[8px] font-bold tracking-[0.3em] text-[#a18478]">ABAYAS &amp; MODEST ESSENTIALS</span></Link>
