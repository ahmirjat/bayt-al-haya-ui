    ...
    <>
      <section className="bg-[#efe4da]">
        <div className="container-page grid items-center gap-12 py-16 lg:grid-cols-2 lg:py-24">
          <div><p className="section-kicker">The heart behind Bayt al-Haya</p><h1 className="mt-3 text-3xl font-semibold">About Us</h1><h2 className="mt-3 text-6xl font-semibold leading-[.95]">Faith-inspired essentials, thoughtfully imagined for family life.</h2><div data-testid="brand-story" className="mt-7 max-w-xl space-y-5 leading-8 text-[#5f5a52]"><p>Bayt al-Haya began with a simple idea: modest clothing should feel graceful, comfortable, and easy to wear every day.</p><p>We are building a thoughtful collection of abayas, hijabs, prayer wear, men&apos;s items, children&apos;s essentials, and everyday modest pieces for individuals and families.</p><p><strong>Our mission:</strong> to offer modest essentials that help individuals and families dress with comfort, dignity, and grace.</p></div></div>
      ...
      <section className="container-page grid gap-8 rounded-[2rem] bg-[#75665f] p-8 text-white sm:p-14 lg:grid-cols-2"><div><p className="section-kicker !text-[#ead0c3]">Our story is growing</p><h2 className="mt-3 text-5xl font-semibold">Made to meet families in everyday moments</h2></div><div className="flex items-center"><p className="leading-8 text-white/80">From a calm morning to prayer, school, work, or an important gathering, Bayt al-Haya is imagining modest essentials that feel considered and comfortable. This prototype is the beginning of our story, and the collection will grow gradually with our community.</p></div></section>
    </>
  );
}
