...
export const products: Product[] = [
  ...
  { slug: "prayer-khimar-set", name: "Prayer Khimar Set", category: "Prayer Wear", price: 75, description: "A soft two-piece concept created for comfort, coverage, and ease.", details: "Prototype preview of a long khimar and matching skirt in a breathable, opaque fabric.", colors: ["#a6afa0", "#697466"], image: assetPath("/images/family/prayer-khimar-lifestyle.png"), imageAlt: "Woman wearing a graceful warm mocha prayer khimar set in a peaceful sunlit room", colorName: "Warm Mocha", sizes: "One Size", badge: "Coming Soon", prototypeLabel: "Coming Soon" },
  { slug: "mens-modest-thobe", name: "Men's Modest Thobe", category: "Men's Essentials", price: 85, description: "A clean, comfortable thobe concept for prayer, gatherings, and everyday wear.", details: "Prototype preview with a relaxed fit, understated collar, and practical side pockets.", colors: ["#c9b9a6", "#75665f"], image: assetPath("/images/family/mens-thobe-lifestyle.png"), imageAlt: "Man wearing an elegant cream modest thobe and prayer cap in a warm sunlit courtyard", colorName: "Warm Stone", sizes: "S-XXL", badge: "Coming Soon", prototypeLabel: "Coming Soon" },
  { slug: "mens-prayer-cap", name: "Men's Prayer Cap", category: "Men's Essentials", price: 18, description: "A simple prayer cap concept designed for a comfortable everyday fit.", details: "Prototype preview with a soft neutral finish and understated stitched detail.", colors: ["#eee3dc", "#9a887c"], image: assetPath("/images/family/mens-thobe-lifestyle.png"), imageAlt: "Man wearing a detailed cream prayer cap with a modest thobe in a warm courtyard", colorName: "Soft Cream", sizes: "S-L", badge: "Demo Product", prototypeLabel: "Demo Product" },
  { slug: "childrens-prayer-outfit", name: "Children's Prayer Outfit", category: "Children's Essentials", price: 48, description: "A gentle prayer outfit concept made to help little ones feel comfortable and included.", details: "Prototype preview with easy coverage, soft fabric, and a simple pull-on design.", colors: ["#d8c9bd", "#a88f80"], image: assetPath("/images/family/childrens-modest-lifestyle.png"), imageAlt: "Smiling child wearing a soft rose prayer outfit beside a sibling in a warm courtyard", colorName: "Rose Sand", sizes: "4-12", badge: "Coming Soon", prototypeLabel: "Coming Soon" },
  { slug: "childrens-modest-set", name: "Children's Modest Set", category: "Children's Essentials", price: 55, description: "An easy layered set concept for school days, family visits, and celebrations.", details: "Prototype preview featuring a relaxed tunic and coordinating comfortable trousers.", colors: ["#b0a594", "#70675b"], image: assetPath("/images/family/childrens-modest-lifestyle.png"), imageAlt: "Smiling siblings wearing warm taupe and rose modest outfits in a sunlit courtyard", colorName: "Warm Taupe", sizes: "4-12", badge: "Prototype Preview", prototypeLabel: "Prototype Preview" },
  ...
  { slug: "modest-gift-set", name: "Modest Gift Set", category: "Everyday Modest Pieces", price: 45, description: "A thoughtful gift concept with simple modest essentials for meaningful moments.", details: "Prototype preview of a coordinated scarf, prayer accessory, and keepsake pouch.", colors: ["#c9b9a6", "#8c7765"], image: assetPath("/images/family/modest-gift-set-lifestyle.png"), imageAlt: "Warm modest gift set with a rose hijab, prayer beads, prayer mat, and keepsake pouch", colorName: "Soft Sand", sizes: "One Size", badge: "Coming Soon", prototypeLabel: "Coming Soon" },
];
